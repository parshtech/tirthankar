class MusicData {
  ...
  @override
  String toString() {
    return '{ ${this.id},${this.pdfpage},${this.linkid}, ${this.title},${this.album}, ${this.songURL}, ${this.hindiName},  ${this.mname} , ${this.msign}, ${this.other1} , ${this.other2}, ${this.ename} , ${this.esign} ,${this.language},${this.songtext},${this.pdffile},${this.isfave} }';
  }
