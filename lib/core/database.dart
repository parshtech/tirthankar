...
class database {
  ...
  _onCreate(Database db, int version) async {
    ...
    await db.execute(
        "CREATE TABLE SONGS (id INTEGER PRIMARY KEY,pdfpage INTEGER,linkid INTEGER, title TEXT, album TEXT, songURL TEXT, hindiName TEXT,mname TEXT, msign TEXT, other1 TEXT,other2 TEXT, ename TEXT, esign TEXT, language TEXT, songtext TEXT, isfave INTEGER");
  }
  ...
  Future<Batch> buildBatch(MusicData musicData) async {
    ...
    throw "Error in buildbatch method";
  ...
  Future<List<MusicData>> getSongs(int id) async {
    ...
    List<Map> maps = await dbClient!
        .query(TABLE, columns: [ID], where: '$ID = ?', whereArgs: [id]);
